...
class StateMachineModel:
    ...
    def _populate_states_from_definition(self) -> dict:
        ...
        for state_name, state_details in self._definition['States'].items():
            new_state = self._create_state_model(state_name=state_name, state_type=state_details['Type'], state_details=state_details)
            state_dictionary[state_name] = new_state
        return state_dictionary

    def _create_state_model(self, state_name:str, state_type:str, state_details:dict) -> AbstractStateModel:
